...
@click.command()
@click.option('--src', type = click.STRING, help = 'Sorce folder that contains markdown files to be merged.')
@click.option('--dst', type = click.STRING, help = 'Destination folder that contains existing,categorized markdown files.')
