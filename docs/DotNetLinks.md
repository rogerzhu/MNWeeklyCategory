...
1. [搭建 .NET 开发 Storm 拓扑的环境 (ziyunhx)](https://weekly.manong.io/bounce?url=http%3A%2F%2Fblog.tnidea.com%2Fdeploy-storm-environment.html&aid=3111&nid=82)
1. [.NET 使用 DRPC 远程调用运行在 Storm 上的 Topology (ziyunhx)](https://weekly.manong.io/bounce?url=http%3A%2F%2Fblog.tnidea.com%2Fdot-net-drpc-storm.html&aid=3256&nid=84)
